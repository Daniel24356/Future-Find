...
//     exportAs, selectDate, onClose, onSelectProvider
// }) => {
...
//     ]
//     const providerList = [
//         {name:'ikeja-electric'}, {name:'eko-electric'}, {name:'portharcourt-electric'}, {name:'jos-electric'}, {name:'kano-electric'}, {name:'ibadan-electric'}, {name:'enugu-electric'}, {name: 'abuja-electric'},  {name: 'benin-electric'}
//     ]
//     const months = [
